 ...
 * @author Carlos J
 */
public class ServidorDerscargar extends SwingWorker{
    ...
    protected Object doInBackground() throws Exception {
        servidor=new ServerSocket(1235);
        while(seguir){
            try {                       
                //Crear el canal
                ...
                archivo = new File("C:\\Users\\Carlos J\\Downloads\\"+nomFile);
    ...
    protected void process(List list) {
        JOptionPane.showMessageDialog(null,"Archivo "+nomFile+" Descargado");
    }
